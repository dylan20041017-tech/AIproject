    ...
    <div class="sidebar">
      ...
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <el-image :src="iconUrl" alt="logo" style="width: 25px; height: 25px;" />
        </div>
        ...
        <div class="warm-tips">
          ...
          <div class="emotion-intensity">
            <span class="intensity-dots">
              <span class="dot" v-for=" i in 3" :key="i" :class="{'active' :getIntensityClass(currentEmotion.emotionScore)>=i}"></span>
            </span>
          ...
          <!-- 温暖卡片建议 -->
           ...
           <!-- 治愈行动 -->
            <div class="healing-actions" v-if="currentEmotion.improvementSuggestions.length > 0">
              <div class="healing-title">治愈小行动</div>
      ...
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <el-image :src="iconUrl2" alt="logo" style="width: 30px; height: 30px;" />
          </div>
          <div class="chat-info">
            <h2>宁渡AI助手</h2>
            <p>获取专业的心理健康建议</p>
...
const startAiResponse = (sessionId, userMessage) => {
  if (isAiTyping.value) {
    ElMessage.error('AI助手正在发送中，稍后再试。')
    return
  }
